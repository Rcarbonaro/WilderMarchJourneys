...
func _ready() -> void:
	...
	_build_roster()
	AudioManager.wire_all_buttons_in(self)   # MOVED (was above _build_roster()) — it ran before the card/description buttons existed, so none of them got click/hover sfx
	_refresh_ui()
